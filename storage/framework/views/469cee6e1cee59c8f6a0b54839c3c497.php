                                        ...
                                        <label
                                            ...
                                            <span class="pr-1 d-flex align-items-center switch--label">
                                                ...
                                                <span class="form-label-secondary text-danger d-flex"
                                                    ...
                                                    data-original-title="<?php echo e(translate('messages.Customer_can_give_tips_to_deliveryman_during_checkout_from_the_customer_app_&_website._From_this,_admin_has_no_commission.')); ?>"><img
                                                        src="<?php echo e(asset('/public/assets/admin/img/info-circle.svg')); ?>"
                                                        alt="<?php echo e(translate('messages.dm_tips_model_hint')); ?>"> * </span>
                                            </span>
                                            <input type="checkbox"
                                ...
                                <div class="col-sm-6 col-lg-4">
                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        <label
                                            ...
                                            <span class="pr-1 d-flex align-items-center switch--label">
                                                <span class="line--limit-1">
                                                    <?php echo e(translate('Show Earnings in App')); ?>

                                                </span>
                                                <span class="form-label-secondary text-danger d-flex"
                                                    data-toggle="tooltip" data-placement="right"
                                                    data-original-title="<?php echo e(translate('messages.With_this_feature,_Deliverymen_can_see_their_earnings_on_a_specific_order_while_accepting_it.')); ?>"><img
                                                        src="<?php echo e(asset('/public/assets/admin/img/info-circle.svg')); ?>"
                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        <label
                                            ...
                                            <span class="pr-1 d-flex align-items-center switch--label">
                                                ...
                                                <span class="form-label-secondary text-danger d-flex"
                                                    data-toggle="tooltip" data-placement="right"
                                                    data-original-title="<?php echo e(translate('messages.With_this_feature,_deliverymen_can_register_themselves_from_the_Customer_App,_Website_or_Deliveryman_App_or_Admin_Landing_Page._The_admin_will_receive_an_email_notification_and_can_accept_or_reject_the_request.')); ?>"><img
                                                        src="<?php echo e(asset('/public/assets/admin/img/info-circle.svg')); ?>"
                                            ...
                                            <input type="checkbox"
                                                   ...
                                                   data-type="toggle"
                                                   data-image-on="<?php echo e(asset('/public/assets/admin/img/modal/dm-self-reg-on.png')); ?>"
                                                   data-image-off="<?php echo e(asset('/public/assets/admin/img/modal/dm-self-reg-off.png')); ?>"
                                    ...
                                    <div class="form-group mb-0">
                                        <label class="form-label text-capitalize"
                                            ...
                                            <div class="d-flex align-items-center">
                                                <span class="line--limit-1 flex-grow"><?php echo e(translate('Maximum Assigned Order Limit')); ?> </span> <small
                                                class="text-danger d-flex align-items-center mt-1"> *<span class="form-label-secondary"
                                                    data-toggle="tooltip" data-placement="right"
                                                    data-original-title="<?php echo e(translate('messages.Set_the_maximum_order_limit_a_Deliveryman_can_take_at_a_time.')); ?>"><img
                                                        src="<?php echo e(asset('/public/assets/admin/img/info-circle.svg')); ?>"
                                        ...
                                        <input type="number" name="dm_maximum_orders" class="form-control"
                                            ...
                                            value="<?php echo e($dm_maximum_orders ? $dm_maximum_orders->value : 1); ?>" required>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-lg-4">
                                    ...
                                    <div class="form-group mb-0">
                                        <label class="input-label text-capitalize d-flex align-items-center"><span
                                                class="line--limit-1"><?php echo e(translate('messages.Can_A_Deliveryman_Cancel_Order?')); ?></span>
                                            <span class="form-label-secondary"
                                            data-toggle="tooltip" data-placement="right"
                                            data-original-title="<?php echo e(translate('messages.Admin_can_enable/disable_Deliveryman’s_order_cancellation_option_in_the_respective_app.')); ?>"><img
                                                src="<?php echo e(asset('/public/assets/admin/img/info-circle.svg')); ?>"
                                                alt="<?php echo e(translate('messages.dm_cancel_order_hint')); ?>"></span></label>
                                    ...
                                    <div class="form-group mb-0">
                                        <label
                                            ...
                                            <span class="pr-1 d-flex align-items-center switch--label">
                                                ...
                                                <span class="form-label-secondary text-danger d-flex"
                                                    data-toggle="tooltip" data-placement="right"
                                                    data-original-title="<?php echo e(translate('messages.If_enabled,_deliverymen_will_see_an_option_to_take_pictures_of_the_delivered_products_when_he_swipes_the_delivery_confirmation_slide.')); ?>"><img
                                                        src="<?php echo e(asset('/public/assets/admin/img/info-circle.svg')); ?>"
                                                        alt="<?php echo e(translate('messages.dm_picture_upload_status')); ?>"> * </span>
                                            </span>
                                            <input type="checkbox"
                                    ...
                                    <div class="form-label  mb-0 ">
                                        ...
                                        <label
                                            ...
                                            <span class="pr-1 d-flex align-items-center switch--label">
                                                ...
                                                <span class="form-label-secondary text-danger d-flex"
                                                      data-toggle="tooltip" data-placement="right"
                                                      data-original-title="<?php echo e(translate('If_enabled,_delivery_men_will_be_automatically_suspended_by_the_system_when_their_‘Cash_in_Hand’_limit_is_exceeded.')); ?>"><img
                                                        src="<?php echo e(asset('/public/assets/admin/img/info-circle.svg')); ?>"
                                ...
                                <div class="col-sm-6 col-lg-4">
                                    ...
                                    <div class="form-label mb-0">
                                        <label class="d-flex text-capitalize"
                                            ...
                                            <span data-toggle="tooltip" data-placement="right" data-original-title="<?php echo e(translate('Deliveryman_can_not_accept_any_orders_when_the_Cash_In_Hand_limit_exceeds_and_must_deposit_the_amount_to_the_admin_before_accepting_new_orders')); ?>" class="input-label-secondary"><img src="<?php echo e(asset('/public/assets/admin/img/info-circle.svg')); ?>" alt="<?php echo e(translate('messages.dm_maximum_order_hint')); ?>"></span>
                                        </label>
                                        <input type="number" name="dm_max_cash_in_hand" class="form-control"
                                               id="dm_max_cash_in_hand" min="0" step=".001"
                                               value="<?php echo e($dm_max_cash_in_hand ? $dm_max_cash_in_hand->value : ''); ?>" <?php echo e($cash_in_hand_overflow  == 1 ? 'required' : 'readonly'); ?> >
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-lg-4">
                                    ...
                                    <div class="form-label mb-0">
                                        <label class="text-capitalize"
                                            ...
                                            <span class="form-label-secondary"
                                                  data-toggle="tooltip" data-placement="right"
                                                  data-original-title="<?php echo e(translate('Enter_the_minimum_cash_amount_delivery_men_can_pay')); ?>"><img
                                                    src="<?php echo e(asset('/public/assets/admin/img/info-circle.svg')); ?>"
                                        ...
                                        <input type="number" name="min_amount_to_pay_dm" class="form-control"
                                               ...
                                               value="<?php echo e($min_amount_to_pay_dm ? $min_amount_to_pay_dm->value : ''); ?>"  <?php echo e($cash_in_hand_overflow  == 1 ? 'required' : 'readonly'); ?> >
                                    </div>
                                </div>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Admin\resources\views/admin-views/business-settings/deliveryman-index.blade.php ENDPATH**/ ?>