...
<?php $__env->startSection('content'); ?>
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <h1 class="page-header-title">
                ...
                <span><?php echo e(translate('messages.update_store')); ?></span>
            </h1>
        </div>
        <?php
    ...
    ?>
                            ...
                            id="default-form">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name[]" id="default_name"
                                        class="form-control" placeholder="<?php echo e(translate('messages.store_name')); ?>" value="<?php echo e($store->getRawOriginal('name')); ?>"
                                        required
                                         >
                                </div>
                                ...
                                <div class="form-group mb-0">
                                    ...
                                    <textarea type="text" name="address[]" placeholder="<?php echo e(translate('messages.store')); ?>" class="form-control min-h-90px ckeditor"><?php echo e($store->getRawOriginal('address')); ?></textarea>
                                </div>
                            </div>
                                <?php $__currentLoopData = json_decode($language); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                    ...
                    <div class="card shadow--card-2">
                        <div class="card-header">
                            <h5 class="card-title">
                                ...
                                <span><?php echo e(translate('Store Logo & Covers')); ?></span>
                            </h5>
                        </div>
                        <div class="card-body">
                            <div class="d-flex flex-wrap flex-sm-nowrap __gap-12px">
                                <div class="__custom-upload-img mr-lg-5">
                                    ...
                                    <label class="text-center position-relative">
                                        ...
                                        src="<?php echo e($store->logo_full_url ?? asset('public/assets/admin/img/upload-img.png')); ?>"
                                            alt="logo image" />
                                ...
                                <div class="__custom-upload-img">
                                    ...
                                    <?php ($icon = $icon->value ?? ''); ?>
                                    <label class="form-label">
                                        <?php echo e(translate('Store Cover')); ?>  <span class="text--primary">(<?php echo e(translate('2:1')); ?>)</span>
                                    </label>
                                    <label class="text-center position-relative">
                                        <img class="img--vertical min-height-170px min-width-170px onerror-image image--border" id="coverImageViewer"
                                        data-onerror-image="<?php echo e(asset('public/assets/admin/img/upload-img.png')); ?>"
                                        src="<?php echo e($store->cover_photo_full_url ?? asset('public/assets/admin/img/upload-img.png')); ?>"
                                            alt="Fav icon" />
                                        <div class="icon-file-group">
                                            <div class="icon-file">
                                                <i class="tio-edit"></i>
                            ...
                            <div class="row g-3 my-0">
                                <div class="col-md-12">
                                    <div class="position-relative">
                                        ...
                                        <input type="text" id="time_view" value="<?php echo e($delivery_time_start); ?> to <?php echo e($delivery_time_end); ?> <?php echo e($delivery_time_type); ?>" class="form-control" readonly>
                                            ...
                                            <div class="card shadow--card-2">
                                                <div class="card-body">
                                                    <div class="floating--date-inner">
                                                        <div class="item">
                                                            <label class="input-label"
                                                                for="minimum_delivery_time"><?php echo e(translate('Minimum Time')); ?></label>
                                                            <input id="minimum_delivery_time" type="number" name="minimum_delivery_time" value="<?php echo e($delivery_time_start); ?>" class="form-control h--45px" placeholder="<?php echo e(translate('messages.Ex :')); ?> 30"
                                                                pattern="^[0-9]{2}$" required value="<?php echo e(old('minimum_delivery_time')); ?>">
                                                        </div>
                                                        <div class="item">
                                                            <label class="input-label"
                                                                for="maximum_delivery_time"><?php echo e(translate('Maximum Time')); ?></label>
                                                            <input id="maximum_delivery_time" type="number" name="maximum_delivery_time" value="<?php echo e($delivery_time_end); ?>" class="form-control h--45px" placeholder="<?php echo e(translate('messages.Ex :')); ?> 60"
        ...
        data-original-title="<?php echo e(translate('messages.select_zone_for_map')); ?>"><img src="<?php echo e(asset('/public/assets/admin/img/info-circle.svg')); ?>" alt="<?php echo e(translate('messages.select_zone_for_map')); ?>"></span></label>
                                        <select name="zone_id" id="choice_zones" data-placeholder="<?php echo e(translate('messages.select_zone')); ?>"
                                    ...
                                    <div class="form-group">
                                        <label class="input-label" for="latitude"><?php echo e(translate('messages.latitude')); ?>
                                            ...
                                            <span
                                                class="form-label-secondary" data-toggle="tooltip" data-placement="right"
                                                data-original-title="<?php echo e(translate('messages.store_lat_lng_warning')); ?>">
                                                <img src="<?php echo e(asset('/public/assets/admin/img/info-circle.svg')); ?>" alt="<?php echo e(translate('messages.store_lat_lng_warning')); ?>">
                                            </span>
                                        </label>
                                        <input type="text" id="latitude"
                                                name="latitude" class="form-control"
                                                placeholder="<?php echo e(translate('messages.Ex:')); ?> -94.22213" value="<?php echo e($store->latitude); ?>" required readonly>
                                    </div>
                                    <div class="form-group mb-5">
                                        ...
                                        <input type="text"
                                                ...
                                                placeholder="<?php echo e(translate('messages.Ex:')); ?> 103.344322" id="longitude" value="<?php echo e($store->longitude); ?>" required readonly>
                                    </div>
                                </div>
                                <div class="col-lg-8">
                                    <input id="pac-input" class="controls rounded"
                                        data-toggle="tooltip" data-placement="right" data-original-title="<?php echo e(translate('messages.search_your_location_here')); ?>" type="text" placeholder="<?php echo e(translate('messages.search_here')); ?>" />
                                    <div id="map"></div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row g-3">
                                <div class="col-md-4 col-sm-6">
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="text" name="f_name" class="form-control" placeholder="<?php echo e(translate('messages.first_name')); ?>"
                                                value="<?php echo e($store->vendor->f_name); ?>"  required>
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-6">
                                    <div class="form-group mb-0">
                                        <label class="input-label" for="l_name"><?php echo e(translate('messages.last_name')); ?></label>
                                        <input type="text" name="l_name" class="form-control" placeholder="<?php echo e(translate('messages.last_name')); ?>"
                                ...
                                <div class="col-md-4 col-sm-6">
                                    <div class="form-group mb-0">
                                        ...
                                        placeholder="<?php echo e(translate('messages.Ex:')); ?> 017********" value="<?php echo e($store->vendor->phone); ?>"
                                        required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-4 col-sm-6">
                                    <div class="js-form-message form-group mb-0">
                                        <label class="input-label" for="signupSrPassword"><?php echo e(translate('password')); ?><span class="form-label-secondary" data-toggle="tooltip" data-placement="right"
                                ...
                                <div class="col-md-4 col-sm-6">
                                    <div class="js-form-message form-group mb-0">
                                        <label class="input-label" for="signupSrConfirmPassword"><?php echo e(translate('messages.Confirm Password')); ?></label>
                            ...
                            <div class="row g-3">
                                <div class="col-md-8 col-xxl-9">
                                    <div class="bg--secondary rounded p-20 h-100">
                                        <div class="form-group">
                                            <label class="input-label mb-2 d-block title-clr fw-normal" for="exampleFormControlInput1"><?php echo e(translate('Taxpayer Identification Number(TIN)')); ?> <span class="text-danger">*</span></label>
                                            <input type="text" name="tin" placeholder="<?php echo e(translate('Type Your Taxpayer Identification Number(TIN)')); ?>" class="form-control"
                                                   value="<?php echo e($store->tin); ?>"  required>
                                        </div>
                                        <div class="form-group mb-0">
                                            <label class="input-label mb-2 d-block title-clr fw-normal" for="exampleFormControlInput1"><?php echo e(translate('Expire Date')); ?> <span class="text-danger">*</span></label>
                                            <input type="date" name="tin_expire_date" class="form-control" value="<?php echo e($store->tin_expire_date); ?>" required>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="bg--secondary rounded p-20 h-100 single-document-uploaderwrap">
                                        ...
                                        <div>
                                            ...
                                            <div class="d-flex justify-content-center" id="pdf-container">
                                                ...
                                                <div class="pdf-single" data-file-name="${file.name}" data-file-url="<?php echo e($store->tin_certificate_image_full_url ?? asset('public/assets/admin/img/upload-cloud.png')); ?>">
                                                    <div class="pdf-frame">
                                                    ...
                                                    <div class="overlay">
                                                        <div class="pdf-info">
                                                            <?php if(Str::endsWith($imgPath, ['.pdf', '.doc', '.docx'])): ?>
                                                                <img src="<?php echo e(asset('public/assets/admin/img/document.svg')); ?>" width="34" alt="File Type Logo">
                                                            <?php else: ?>
                                                                <img src="<?php echo e(asset('public/assets/admin/img/picture.svg')); ?>" width="34" alt="File Type Logo">
                                                            <?php endif; ?>
                                                            <div class="file-name-wrapper">
                                                                <span class="file-name js-filename-truncate"><?php echo e($store->tin_certificate_image); ?></span>
...
<?php $__env->startPush('script_2'); ?>
    ...
    <script src="<?php echo e(asset('public/assets/admin/js/file-preview/edit-multiple-document-upload.js')); ?>"></script>
            ...
            function previewFile(inputSelector, previewImgSelector, textBoxSelector) {
                ...
                input.on('change', function () {
                    ...
                    if (validImageTypes.includes(fileType)) {
                        ...
                        imagePreview.attr('src', '<?php echo e(asset('public/assets/admin/img/file-icon.png')); ?>').removeClass('display-none');
                        textBox.hide();
                    }
                });
            }
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Admin\resources\views/admin-views/vendor/edit.blade.php ENDPATH**/ ?>