                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="<?php echo e(route('update-system')); ?>">
                        ...
                        <div class="text-center">
                            <button type="submit" class="btn btn-dark px-sm-5" <?php echo e($phpVersion >= 8.1?'':'disabled'); ?>>Update</button>
                        </div>
                    </form>
                </div>
            </div>
...
<?php echo $__env->make('layouts.blank', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Admin\resources\views/update/update-software.blade.php ENDPATH**/ ?>