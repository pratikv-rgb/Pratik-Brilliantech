                        ...
                        <ul id="navbarSettings"
                            ...
                            <li class="nav-item">
                                <a class="nav-link active text-dark" href="javascript:" id="generalSection">
                                    <i class="tio-user-outlined nav-icon"></i> <span><?php echo e(translate('messages.basic_information')); ?></span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-dark" href="javascript:" id="passwordSection">
                                    <i class="tio-lock-outlined nav-icon"></i> <span><?php echo e(translate('messages.password')); ?></span>
                                </a>
                            </li>
                        </ul>
                        <!-- End Navbar Nav -->
            ...
            <div class="col-lg-9">
                    ...
                    <div class="card mb-3 mb-lg-5">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row form-group">
                                <label for="firstNameLabel" class="col-sm-3 col-form-label input-label d-flex"><span><?php echo e(translate('messages.full_name')); ?></span> <i
                                        class="tio-help-outlined text-body ml-1" data-toggle="tooltip"
                                        data-placement="top"
                                        title="<?php echo e(translate('Display_name')); ?>"></i></label>
                            ...
                            <div class="d-flex justify-content-end">
                                <button type="button" data-id="admin-settings-form" data-message="<?php echo e(translate('Want to update admin info ?')); ?>" class="btn btn-primary <?php echo e(env('APP_MODE')!='demo'?"form-alert":"call-demo"); ?>"><?php echo e(translate('messages.save')); ?></button>
                            </div>
                ...
                <div id="passwordDiv" class="card mb-3 mb-lg-5">
                    ...
                    <div class="card-body">
                        ...
                        <!-- Form Group -->
                            <div class="row form-group">
                                <label for="newPassword" class="col-sm-3 col-form-label input-label"><?php echo e(translate('messages.new_password')); ?><span class="form-label-secondary" data-toggle="tooltip" data-placement="right"
        data-original-title="<?php echo e(translate('messages.Must_contain_at_least_one_number_and_one_uppercase_and_lowercase_letter_and_symbol,_and_at_least_8_or_more_characters')); ?>"><img src="<?php echo e(asset('/public/assets/admin/img/info-circle.svg')); ?>" alt="<?php echo e(translate('messages.Must_contain_at_least_one_number_and_one_uppercase_and_lowercase_letter_and_symbol,_and_at_least_8_or_more_characters')); ?>"></span></label>
                                ...
                                <div class="col-sm-9">
                                    <input type="password" class="js-pwstrength form-control" name="password"
                                           id="newPassword" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="<?php echo e(translate('messages.Must_contain_at_least_one_number_and_one_uppercase_and_lowercase_letter_and_symbol,_and_at_least_8_or_more_characters')); ?>"
                                ...
                                <div class="col-sm-9">
                                    <div class="mb-3">
                                        <input type="password" class="form-control" name="confirm_password"
                                               id="confirmNewPasswordLabel" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="<?php echo e(translate('messages.Must_contain_at_least_one_number_and_one_uppercase_and_lowercase_letter_and_symbol,_and_at_least_8_or_more_characters')); ?>"
                                               placeholder="<?php echo e(translate('messages.password_length_placeholder', ['length' => '8+'])); ?>"
                            ...
                            <div class="d-flex justify-content-end">
                                <button type="button" data-id="changePasswordForm" data-message="<?php echo e(translate('messages.want_to_update_admin_password')); ?>" class="btn btn-primary <?php echo e(env('APP_MODE')!='demo'?"form-alert":"call-demo"); ?>"><?php echo e(translate('messages.save')); ?></button>
                            </div>
                        </form>
                        <!-- End Form -->
                    </div>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Admin\resources\views/admin-views/settings.blade.php ENDPATH**/ ?>