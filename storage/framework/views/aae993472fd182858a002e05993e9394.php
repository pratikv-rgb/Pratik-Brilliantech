...
<div class="footer text-center">
    <ul class="list-inline list-separator">
        <li class="list-inline-item">
            <a class="list-separator-link" target="_blank" href="<?php echo e(route('contact-us')); ?>"><?php echo e(\App\Models\BusinessSetting::where(['key'=>'business_name'])->first()->value??'Stack Food'); ?> <?php echo e(translate('messages.support')); ?></a>
        </li>
    </ul>
</div>
<!-- End Footer -->
...
<?php /**PATH C:\xampp\htdocs\Admin\resources\views/errors/404.blade.php ENDPATH**/ ?>