                            ...
                            <div class="pdf-single  cus-document-responsive"
                                ...
                                <div class="overlay">
                                    ...
                                    <div class="pdf-info d-flex gap-10px align-items-center">
                                        <?php if(Str::endsWith($imgPath, ['.pdf', '.doc', '.docx'])): ?>
                                            <img src="<?php echo e(asset('public/assets/admin/img/document.svg')); ?>" width="34"
                                                alt="File Type Logo">
                                        <?php else: ?>
                                            <img src="<?php echo e(asset('public/assets/admin/img/picture.svg')); ?>" width="34"
                                                alt="File Type Logo">
                                        <?php endif; ?>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Admin\resources\views/admin-views/vendor/view/index.blade.php ENDPATH**/ ?>