<?php $__env->startSection('title', translate('messages.contact_us')); ?>
    ...
    <section class="about-section py-5 position-relative">
        <div class=" container contact-container">
            <div class="section-header">
                ...
                <h2 class="title mb-2"><?php echo e($contact_us_title); ?></h2>
                <div class="text"><?php echo e($contact_us_sub_title); ?></div>
            </div>
            ...
            <div class="contact-img">
                <img src="<?php echo e(\App\CentralLogics\Helpers::get_full_url('contact_us_image',$contact_us_image?->value,$contact_us_image?->storage[0]?->value ?? 'public')); ?>" alt="">
            </div>
            <div class="row gy-5 mt-0">
                        ...
                        <div class="col-sm-6">
                            <div class="contact-item">
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <h5 class="subtitle"><?php echo e(translate("messages.Call_Us")); ?> </h5>
                                </div>
                                <ul>
                                    <li>
                        ...
                        <div class="col-sm-6">
                            <div class="contact-item">
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <h5 class="subtitle"><?php echo e(translate("messages.Email")); ?></h5>
                                </div>
                                <ul>
                                    <li>
                                        <a href="Malto:<?php echo e(\App\CentralLogics\Helpers::get_settings('email_address')); ?>"><?php echo e(\App\CentralLogics\Helpers::get_settings('email_address')); ?></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="contact-item">
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <h5 class="subtitle"><?php echo e(translate("messages.Address")); ?></h5>
                                </div>
                                <ul>
                                    <li>
                                        ...
                                        <a href="https://www.google.com/maps/search/?api=1&query=<?php echo e(data_get($default_location,'lat',0)); ?>,<?php echo e(data_get($default_location,'lng',0)); ?>" target="_blank"><?php echo e(\App\CentralLogics\Helpers::get_settings('address')); ?></a>
                        ...
                        <div class="col-sm-6">
                            <div class="contact-item">
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <h5 class="subtitle"><?php echo e(translate("messages.Time")); ?></h5>
                                </div>
                                <ul>
                                    <li>
                                        <?php echo e(translate(\App\CentralLogics\Helpers::get_settings('opening_day'))); ?>- <?php echo e(translate(\App\CentralLogics\Helpers::get_settings('closing_day'))); ?>

                                    </li>
                                    <li>
                                        <?php echo e(\App\CentralLogics\Helpers::time_format(\App\CentralLogics\Helpers::get_settings('opening_time'))); ?>- <?php echo e(\App\CentralLogics\Helpers::time_format( \App\CentralLogics\Helpers::get_settings('closing_time'))); ?>
                ...
                <div class="col-lg-6">
                    <form class="contact-form-wrapper" method="post" action="<?php echo e(route('send-message')); ?>" id="form-id">
                        <?php echo csrf_field(); ?>
                        <div class="row g-4">
                            <div class="col-sm-6">
                                <input type="text" required name="name" placeholder="<?php echo e(translate('Your Name')); ?>" class="form-control form--control">
                            </div>
                            <div class="col-sm-6">
                                <input type="email" required name="email" placeholder="<?php echo e(translate('Email')); ?>" class="form-control form--control">
                            </div>
                            <div class="col-sm-12">
                                <input type="text" required name="subject" placeholder="<?php echo e(translate('Subject')); ?>" class="form-control form--control">
                            </div>
                            <div class="col-sm-12">
                            ...
                            <div class="col-sm-12 text-center">
                                <button class="cmn--btn border-0" type="submit" id="signInBtn"><?php echo e(translate("messages.Send_Message")); ?> </button>
                            </div>
                        </div>
                    </form>
                </div>
...
<?php echo $__env->make('layouts.landing.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Admin\resources\views/contact-us.blade.php ENDPATH**/ ?>