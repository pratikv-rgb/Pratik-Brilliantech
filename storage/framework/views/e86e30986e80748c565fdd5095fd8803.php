        ...
        <div class="navbar-vertical-container">
            <div class="navbar-brand-wrapper justify-content-between">
                ...
                <a class="navbar-brand" href="<?php echo e(route('vendor.dashboard')); ?>" aria-label="Front">
                    <img class="navbar-brand-logo initial--36  onerror-image"  data-onerror-image="<?php echo e(asset('assets/admin/img/160x160/img2.jpg')); ?>"
                         src="<?php echo e($store_data->logo_full_url); ?>"
 alt="Logo">
                    <img class="navbar-brand-logo-mini initial--36 onerror-image"  data-onerror-image="<?php echo e(asset('assets/admin/img/160x160/img2.jpg')); ?>"
                         src="<?php echo e($store_data->logo_full_url); ?>"
 alt="Logo">
                </a>
                <!-- End Logo -->
            ...
            <div class="navbar-vertical-content text-capitalize bg--005555" id="navbar-vertical-content">
                <form class="sidebar--search-form">
                    <div class="search--form-group">
                        ...
                        <input type="text" class="form-control form--control" placeholder="<?php echo e(translate('messages.Search Menu...')); ?>" id="search-sidebar-menu">
                    </div>
                </form>
                <ul class="navbar-nav navbar-nav-lg nav-tabs">
                    ...
                    <li class="navbar-vertical-aside-has-menu <?php echo e(Request::is('vendor-panel/pos')?'active':''); ?>">
                        <a class="js-navbar-vertical-aside-menu-link nav-link  " href="<?php echo e(route('vendor.pos.index')); ?>"
                            title="<?php echo e(translate('messages.pos')); ?>">
                            <i class="tio-shopping-basket-outlined nav-icon"></i>
                            <span
                                class="text-truncate"><?php echo e(translate('messages.pos')); ?></span>
                        </a>
                    </li>
                    <?php endif; ?>
                    <?php if(\App\CentralLogics\Helpers::employee_module_permission_check('order')): ?>
                    <li class="nav-item">
                        <small class="nav-subtitle" title="<?php echo e(translate('messages.order_section')); ?>"><?php echo e(translate('messages.order_section')); ?></small>
                    ...
                    <li class="navbar-vertical-aside-has-menu <?php echo e(Request::is('vendor-panel/order*')?'active':''); ?>">
                        ...
                        <ul class="js-navbar-vertical-aside-submenu nav nav-sub" style="display: <?php echo e(Request::is('vendor-panel/order*')?'block':'none'); ?>">
                            <li class="nav-item <?php echo e(Request::is('vendor-panel/order/list/all')?'active':''); ?>">
                                <a class="nav-link" href="<?php echo e(route('vendor.order.list',['all'])); ?>" title="<?php echo e(translate('messages.all_orders')); ?>">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate sidebar--badge-container">
                                        <?php echo e(translate('messages.all')); ?>

                                        <span class="badge badge-soft-info badge-pill ml-1">
                                            <?php echo e(\App\Models\Order::where('store_id', \App\CentralLogics\Helpers::get_store_id())
                            ...
                            <li class="nav-item <?php echo e(Request::is('vendor-panel/order/list/pending')?'active':''); ?>">
                                <a class="nav-link " href="<?php echo e(route('vendor.order.list',['pending'])); ?>" title="<?php echo e(translate('messages.pending_orders')); ?>">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate sidebar--badge-container">
                                        <?php echo e(translate('messages.pending')); ?> <?php echo e((config('order_confirmation_model') == 'store' || \App\CentralLogics\Helpers::get_store_data()->sub_self_delivery)?'':translate('messages.take_away')); ?>

                                            <span class="badge badge-soft-success badge-pill ml-1">
                                            <?php if(config('order_confirmation_model') == 'store' || \App\CentralLogics\Helpers::get_store_data()->sub_self_delivery): ?>
                                            <?php echo e(\App\Models\Order::where(['order_status'=>'pending','store_id'=>\App\CentralLogics\Helpers::get_store_id()])->StoreOrder()->OrderScheduledIn(30)->NotDigitalOrder()->count()); ?>

                                            <?php else: ?>
                                            <?php echo e(\App\Models\Order::where(['order_status'=>'pending','store_id'=>\App\CentralLogics\Helpers::get_store_id(), 'order_type'=>'take_away'])->StoreOrder()->OrderScheduledIn(30)->NotDigitalOrder()->count()); ?>
                            ...
                            <li class="nav-item <?php echo e(Request::is('vendor-panel/order/list/confirmed')?'active':''); ?>">
                                <a class="nav-link " href="<?php echo e(route('vendor.order.list',['confirmed'])); ?>" title="<?php echo e(translate('messages.confirmed_orders')); ?>">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate sidebar--badge-container">
                                        <?php echo e(translate('messages.confirmed')); ?>

                                            <span class="badge badge-soft-success badge-pill ml-1">
                                            <?php echo e(\App\Models\Order::whereIn('order_status',['confirmed', 'accepted'])->StoreOrder()->whereNotNull('confirmed')->where('store_id', \App\CentralLogics\Helpers::get_store_id())->OrderScheduledIn(30)->NotDigitalOrder()->count()); ?>
                            ...
                            <li class="nav-item <?php echo e(Request::is('vendor-panel/order/list/cooking')?'active':''); ?>">
                                <a class="nav-link" href="<?php echo e(route('vendor.order.list',['cooking'])); ?>" title="<?php echo e(translate('messages.processing_orders')); ?>">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate sidebar--badge-container">
                                        ...
                                        <?php endif; ?>
                                        <span class="badge badge-soft-info badge-pill ml-1">
                                            <?php echo e(\App\Models\Order::where(['order_status'=>'processing', 'store_id'=>\App\CentralLogics\Helpers::get_store_id()])->StoreOrder()->NotDigitalOrder()->count()); ?>
                            ...
                            <li class="nav-item <?php echo e(Request::is('vendor-panel/order/list/ready_for_delivery')?'active':''); ?>">
                                <a class="nav-link" href="<?php echo e(route('vendor.order.list',['ready_for_delivery'])); ?>" title="<?php echo e(translate('messages.ready_for_delivery')); ?>">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate sidebar--badge-container">
                                        <?php echo e(translate('messages.ready_for_delivery')); ?>

                                        <span class="badge badge-soft-info badge-pill ml-1">
                                            <?php echo e(\App\Models\Order::where(['order_status'=>'handover', 'store_id'=>\App\CentralLogics\Helpers::get_store_id()])->StoreOrder()->NotDigitalOrder()->count()); ?>

                                        </span>
                                    </span>
                                </a>
                            </li>
                            <li class="nav-item <?php echo e(Request::is('vendor-panel/order/list/item_on_the_way')?'active':''); ?>">
                                <a class="nav-link" href="<?php echo e(route('vendor.order.list',['item_on_the_way'])); ?>" title="<?php echo e(translate('messages.items_on_the_way')); ?>">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate sidebar--badge-container">
                                        <?php echo e(translate('messages.item_on_the_way')); ?>

                                        <span class="badge badge-soft-info badge-pill ml-1">
                                            <?php echo e(\App\Models\Order::where(['order_status'=>'picked_up', 'store_id'=>\App\CentralLogics\Helpers::get_store_id()])->StoreOrder()->NotDigitalOrder()->count()); ?>
                            ...
                            <li class="nav-item <?php echo e(Request::is('vendor-panel/order/list/delivered')?'active':''); ?>">
                                <a class="nav-link " href="<?php echo e(route('vendor.order.list',['delivered'])); ?>" title="<?php echo e(translate('messages.delivered_orders')); ?>">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate sidebar--badge-container">
                                        <?php echo e(translate('messages.delivered')); ?>

                                            <span class="badge badge-soft-success badge-pill ml-1">
                                            <?php echo e(\App\Models\Order::where(['order_status'=>'delivered','store_id'=>\App\CentralLogics\Helpers::get_store_id()])->StoreOrder()->NotDigitalOrder()->count()); ?>
                            ...
                            <li class="nav-item <?php echo e(Request::is('vendor-panel/order/list/refunded')?'active':''); ?>">
                                <a class="nav-link " href="<?php echo e(route('vendor.order.list',['refunded'])); ?>" title="<?php echo e(translate('messages.refunded_orders')); ?>">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate sidebar--badge-container">
                                        <?php echo e(translate('messages.refunded')); ?>

                                            <span class="badge badge-soft-danger bg-light badge-pill ml-1">
                                            <?php echo e(\App\Models\Order::Refunded()->where(['store_id'=>\App\CentralLogics\Helpers::get_store_id()])->StoreOrder()->NotDigitalOrder()->count()); ?>
                            ...
                            <li class="nav-item <?php echo e(Request::is('vendor-panel/order/list/scheduled')?'active':''); ?>">
                                <a class="nav-link" href="<?php echo e(route('vendor.order.list',['scheduled'])); ?>" title="<?php echo e(translate('messages.scheduled_orders')); ?>">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate sidebar--badge-container">
                                        <?php echo e(translate('messages.scheduled')); ?>

                                        <span class="badge badge-soft-info badge-pill ml-1">
                                            <?php echo e(\App\Models\Order::where('store_id',\App\CentralLogics\Helpers::get_store_id())->StoreOrder()->Scheduled()->where(function($q){
                    ...
                    <?php if(in_array($store_data->module->module_type , [ 'grocery', 'ecommerce'])  ): ?>
                    <li class="navbar-vertical-aside-has-menu <?php echo e(Request::is('vendor-panel/item/flash-sale*') ? 'active' : ''); ?>">
                        <a class="js-navbar-vertical-aside-menu-link nav-link" href="<?php echo e(route('vendor.item.flash_sale')); ?>" title="<?php echo e(translate('messages.flash_sales')); ?>">
                    ...
                    <li class="nav-item">
                        <small
                            class="nav-subtitle"><?php echo e(translate('messages.item_management')); ?></small>
                        <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                    </li>
                    ...
                    <?php endif; ?>
                    <!-- End AddOn -->
                    <?php if(\App\CentralLogics\Helpers::employee_module_permission_check('item')): ?>
                    <!-- Food -->
                    <li class="navbar-vertical-aside-has-menu <?php echo e(Request::is('vendor-panel/item*')?'active':''); ?>">
                        ...
                        >
                            ...
                            <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate"><?php echo e(translate('messages.items')); ?></span>
                        </a>
                        <ul class="js-navbar-vertical-aside-submenu nav nav-sub" style="display: <?php echo e(Request::is('vendor-panel/item*')?'block':'none'); ?>">
                            <li class="nav-item <?php echo e(Request::is('vendor-panel/item/add-new')?'active':''); ?>">
                                <a class="nav-link " href="<?php echo e(route('vendor.item.add-new')); ?>"
                                    title="<?php echo e(translate('messages.add_new_item')); ?>">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span
                                        class="text-truncate"><?php echo e(translate('messages.add_new')); ?></span>
                                </a>
                            </li>
                            <li class="nav-item <?php echo e(Request::is('vendor-panel/item/list')?'active':''); ?>">
                                <a class="nav-link " href="<?php echo e(route('vendor.item.list')); ?>"
                                    title="<?php echo e(translate('messages.items_list')); ?>">
                                    <span class="tio-circle nav-indicator-icon"></span>
                            ...
                            <li class="nav-item <?php echo e(Request::is('vendor-panel/item/pending/item/list') ||  Request::is('vendor-panel/item/requested/item/view/*') ?'active':''); ?>">
                                <a class="nav-link " href="<?php echo e(route('vendor.item.pending_item_list')); ?>"
                                    title="<?php echo e(translate('messages.pending_item_list')); ?>">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate"><?php echo e(translate('messages.pending_item_list')); ?></span>
                                </a>
                            </li>
                            <?php endif; ?>
                            <?php if(\App\CentralLogics\Helpers::get_mail_status('product_gallery')): ?>
                            <li class="nav-item <?php echo e(Request::is('vendor-panel/item/product-gallery') ? 'active' : ''); ?>">
                                <a class="nav-link " href="<?php echo e(route('vendor.item.product_gallery')); ?>" title="<?php echo e(translate('messages.Product_Gallery')); ?>">
                                    <span class="tio-circle nav-indicator-icon"></span>
                            ...
                            <li class="nav-item <?php echo e(Request::is('vendor-panel/item/stock-limit-list')?'active':''); ?>">
                                <a class="nav-link " href="<?php echo e(route('vendor.item.stock-limit-list')); ?>" title="<?php echo e(translate('messages.Low_stock_list')); ?>">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate"><?php echo e(translate('messages.Low_stock_list')); ?></span>
                                </a>
                            </li>
                            <?php endif; ?>
                            <?php if(\App\CentralLogics\Helpers::get_store_data()->item_section): ?>
                            <li class="nav-item <?php echo e(Request::is('vendor-panel/item/bulk-import')?'active':''); ?>">
                                <a class="nav-link " href="<?php echo e(route('vendor.item.bulk-import')); ?>"
                            ...
                            <li class="nav-item <?php echo e(Request::is('vendor-panel/item/bulk-export')?'active':''); ?>">
                                <a class="nav-link " href="<?php echo e(route('vendor.item.bulk-export-index')); ?>"
                    ...
                    <li class="navbar-vertical-aside-has-menu <?php echo e(Request::is('vendor-panel/category*')?'active':''); ?>">
                        ...
                        <ul class="js-navbar-vertical-aside-submenu nav nav-sub" style="display: <?php echo e(Request::is('vendor-panel/category*')?'block':'none'); ?>">
                    ...
                    <?php if(\App\CentralLogics\Helpers::employee_module_permission_check('deliveryman')): ?>
                        <li class="nav-item">
                            <small class="nav-subtitle"
                                   title="<?php echo e(translate('messages.deliveryman_section')); ?>"><?php echo e(translate('messages.deliveryman_section')); ?></small>
                            <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                        </li>
                ...
                <!-- End DeliveryMan -->
                    ...
                    <li class="nav-item">
                        <small
                            class="nav-subtitle"><?php echo e(translate('messages.marketing_section')); ?></small>
                        <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                    </li>
                    <!-- Campaign -->
                    ...
                    <li class="navbar-vertical-aside-has-menu <?php echo e(Request::is('vendor-panel/campaign*')?'active':''); ?>">
                        ...
                        <ul class="js-navbar-vertical-aside-submenu nav nav-sub"  style="display: <?php echo e(Request::is('vendor-panel/campaign*')?'block':'none'); ?>">
                            <li class="nav-item <?php echo e(Request::is('vendor-panel/campaign/list')?'active':''); ?>">
                                <a class="nav-link " href="<?php echo e(route('vendor.campaign.list')); ?>" title="<?php echo e(translate('messages.basic_campaigns')); ?>">
                                    <span class="tio-circle nav-indicator-icon"></span>
                            ...
                            <li class="nav-item <?php echo e(Request::is('vendor-panel/campaign/item/list')?'active':''); ?>">
                                <a class="nav-link " href="<?php echo e(route('vendor.campaign.itemlist')); ?>" title="<?php echo e(translate('messages.Item Campaigns')); ?>">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate"><?php echo e(translate('messages.Item Campaigns')); ?></span>
                                </a>
                            </li>
                        </ul>
                    </li>
                ...
                <li class="navbar-vertical-aside-has-menu <?php echo e(Request::is('vendor-panel/coupon*') ? 'active' : ''); ?>">
                <a class="js-navbar-vertical-aside-menu-link nav-link"
                ...
                <!-- End Coupon -->
                <!-- Coupon -->
                <?php if(\App\CentralLogics\Helpers::employee_module_permission_check('banner')): ?>
                <li class="navbar-vertical-aside-has-menu <?php echo e(Request::is('vendor-panel/banner*') ? 'active' : ''); ?>">
                    <a class="js-navbar-vertical-aside-menu-link nav-link" href="<?php echo e(route('vendor.banner.list')); ?>" title="<?php echo e(translate('messages.banners')); ?>">
                        <i class="tio-image nav-icon"></i>
                ...
                <?php if(\App\CentralLogics\Helpers::employee_module_permission_check('advertisement')): ?>
                ...
                <li class="navbar-vertical-aside-has-menu <?php echo $__env->yieldContent('advertisement'); ?>">
                    ...
                    style="display: <?php echo e(!Request::is('vendor-panel/advertisement/create*') && Request::is('vendor-panel/advertisement*')?'block':'none'); ?>">
                ...
                <?php endif; ?>
                    ...
                    <li class="nav-item <?php echo e(Request::is('vendor-panel/business-settings/store-setup')?'active':''); ?>">
                        <a class="nav-link " href="<?php echo e(route('vendor.business-settings.store-setup')); ?>" title="<?php echo e(translate('messages.storeConfig')); ?>"
                        >
                            <span class="tio-settings nav-icon"></span>
                            <span
                                class="text-truncate"><?php echo e(translate('messages.storeConfig')); ?></span>
                        </a>
                    </li>
                    <?php endif; ?>

                    <li class="navbar-vertical-aside-has-menu <?php echo e(Request::is('vendor-panel/business-settings/notification-setup')?'active':''); ?>">
                    ...
                    <li class="navbar-vertical-aside-has-menu <?php echo e(Request::is('vendor-panel/store/*')?'active':''); ?>">
                        <a class="js-navbar-vertical-aside-menu-link nav-link"
                    ...
                    <li class="navbar-vertical-aside-has-menu <?php echo $__env->yieldContent('subscriberList'); ?>">
                        <a class="js-navbar-vertical-aside-menu-link nav-link"
                            href="<?php echo e(route('vendor.subscription.subscriberDetail')); ?>"
                    ...
                    <li class="navbar-vertical-aside-has-menu <?php echo e(Request::is('vendor-panel/wallet')?'active':''); ?>">
                        ...
                        <li class="navbar-vertical-aside-has-menu <?php echo e(Request::is('vendor-panel/withdraw-method*')?'active':''); ?>">
                    ...
                    <li class="navbar-vertical-aside-has-menu <?php echo e(Request::is('vendor-panel/message*')?'active':''); ?>">
                        <a class="js-navbar-vertical-aside-menu-link nav-link"
                            href="<?php echo e(route('vendor.message.list')); ?>" title="<?php echo e(translate('messages.chat')); ?>"
                        >
                    ...
                    <li class="navbar-vertical-aside-has-menu <?php echo e(Request::is('vendor/report/expense-report') ? 'active' : ''); ?>">
                    ...
                    <li class="navbar-vertical-aside-has-menu <?php echo e(Request::is('vendor-panel/report/disbursement-report') ? 'active' : ''); ?>">
                    ...
                    <li class="navbar-vertical-aside-has-menu <?php echo $__env->yieldContent('vendor_tax_report'); ?>">
                        <a class="nav-link " href="<?php echo e(route('vendor.report.vendorTax')); ?>"
                    ...
                    <li class="navbar-vertical-aside-has-menu <?php echo e(Request::is('vendor-panel/employee*')?'active':''); ?>">
                        ...
                        <ul class="js-navbar-vertical-aside-submenu nav nav-sub"  style="display: <?php echo e(Request::is('vendor-panel/employee*')?'block':'none'); ?>">
                    ...
                    <!-- End Employee -->
                        ...
                        <div class="promo-card">
                            <div class="position-relative">
                                <img src="<?php echo e(asset('assets/admin/img/promo-2.png')); ?>" class="mw-100" alt="">
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\Admin\resources\views/layouts/vendor/partials/_sidebar.blade.php ENDPATH**/ ?>