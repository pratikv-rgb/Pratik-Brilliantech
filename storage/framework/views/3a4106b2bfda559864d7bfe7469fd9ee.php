    ...
    <div class="content container-fluid">
        ...
        <div class="card mb-3">
            <div class="card-body">
                ...
                <div class="mt-2">
                    <?php echo e(translate('messages.By_turning_the_‘Maintenance_Mode’_ON,_all_your_apps_and_customer_website_will_be_disabled_temporarily._Only_the_Admin_Panel,_Admin_Landing_Page_&_Store_Panel_will_be_functional.')); ?>
            ...
            <div class="row g-3">
                            ...
                            <div class="row g-3">
                                <div class="col-sm-6 col-md-4 col-xl-3">
                                    <div class="form-group mb-0">
                                        <label class="form-label"
                                            for="store_name"><?php echo e(translate('messages.company_name')); ?></label>
                                        <input id="store_name" type="text" name="store_name" value="<?php echo e($name->value ?? ''); ?>"
                                            class="form-control" placeholder="<?php echo e(translate('messages.new_company')); ?>"
                                            required>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-md-4 col-xl-3">
                                <?php ($email = \App\Models\BusinessSetting::where('key', 'email_address')->first()); ?>
                                    <div class="form-group mb-0">
                                        ...
                                        <input id="email" type="email" value="<?php echo e($email->value ?? ''); ?>" name="email"
                                            class="form-control" placeholder="<?php echo e(translate('messages.Ex_:_ex@example.com')); ?>" required>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-md-4 col-xl-3">
                                <?php ($phone = \App\Models\BusinessSetting::where('key', 'phone')->first()); ?>
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="tel"  value="<?php echo e($phone->value ?? ''); ?>"  id="phone"  name="phone"
                                            class="form-control" placeholder="<?php echo e(translate('messages.Ex: +3264124565')); ?>" required>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-md-4 col-xl-3">
                                    <div class="form-group mb-0">
                                ...
                                <div class="col-md-6">
                                    <div class="row g-3">
                                        <div class="col-sm-12">
                                            ...
                                            <div class="form-group mb-0">
                                                <label class="form-label"
                                                    for="address"><?php echo e(translate('messages.address')); ?></label>
                                                <textarea type="text" id="address" name="address" class="form-control h--90px" placeholder="<?php echo e(translate('messages.Ex: address')); ?>" rows="1" required><?php echo e($address->value ?? ''); ?></textarea>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                        ...
                                        <div class="p-3 rounded border border-success">
                                            <div class="d-flex mb-3 fs-12">
                                                ...
                                                <div class="w-0 flex-grow pl-2">
                                                    <?php echo e(translate('clicking_on_the_map_will_set_Latitude_and_Longitude_automatically')); ?>
                ...
                <div class="col-lg-12">
                    <h4 class="card-title mb-3">
                        ...
                        <span><?php echo e(translate('General Settings')); ?></span>
                    </h4>
                    <div class="card">
                        <div class="card-body">
                            <div class="row g-3">
                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        <select id="timezone" name="timezone" class="form-control js-select2-custom">
                                            ...
                                            <option value="Etc/GMT+12"
                                                <?php echo e($tz ? ($tz == 'Etc/GMT+12' ? 'selected' : '') : ''); ?>>(GMT-12:00)International Date Line West</option>
                                            ...
                                            <option value="US/Alaska"
                                                <?php echo e($tz ? ($tz == 'US/Alaska' ? 'selected' : '') : ''); ?>>(GMT-09:00)Alaska</option>
                                            ...
                                            <option value="US/Arizona"
                                                <?php echo e($tz ? ($tz == 'US/Arizona' ? 'selected' : '') : ''); ?>>(GMT-07:00)Arizona</option>
                                            <option value="America/Chihuahua"
                                                <?php echo e($tz ? ($tz == 'America/Chihuahua' ? 'selected' : '') : ''); ?>>(GMT-07:00)Chihuahua, La
                                                Paz, Mazatlan</option>
                                            <option value="US/Mountain"
                                                <?php echo e($tz ? ($tz == 'US/Mountain' ? 'selected' : '') : ''); ?>>(GMT-07:00)Mountain Time (US & Canada)</option>
                                            <option value="America/Managua"
                                                <?php echo e($tz ? ($tz == 'America/Managua' ? 'selected' : '') : ''); ?>>
                                                (GMT-06:00) Central America</option>
                                            <option value="US/Central"
                                                <?php echo e($tz ? ($tz == 'US/Central' ? 'selected' : '') : ''); ?>>(GMT-06:00)Central Time (US & Canada)</option>
                                            ...
                                            <option value="US/Eastern"
                                                <?php echo e($tz ? ($tz == 'US/Eastern' ? 'selected' : '') : ''); ?>>(GMT-05:00)Eastern Time (US & Canada)</option>
                                            ...
                                            <option value="America/Sao_Paulo"
                                                <?php echo e($tz ? ($tz == 'America/Sao_Paulo' ? 'selected' : '') : ''); ?>>(GMT-03:00)Brasilia</option>
                                            ...
                                            <option value="Africa/Casablanca"
                                                <?php echo e($tz ? ($tz == 'Africa/Casablanca' ? 'selected' : '') : ''); ?>>(GMT+00:00)Casablanca,
                                            ...
                                            <option value="Asia/Amman"
                                                <?php echo e($tz ? ($tz == 'Asia/Amman' ? 'selected' : '') : ''); ?>>(GMT+02:00)Amman</option>
                                            <option value="Europe/Athens"
                                                <?php echo e($tz ? ($tz == 'Europe/Athens' ? 'selected' : '') : ''); ?>>
                                                (GMT+02:00) Athens, Bucharest, Istanbul</option>
                                            <option value="Asia/Beirut"
                                                <?php echo e($tz ? ($tz == 'Asia/Beirut' ? 'selected' : '') : ''); ?>>(GMT+02:00)Beirut</option>
                                            ...
                                            <option value="Asia/Kuwait"
                                                <?php echo e($tz ? ($tz == 'Asia/Kuwait' ? 'selected' : '') : ''); ?>>(GMT+03:00)Kuwait, Riyadh Baghdad</option>
                                            ...
                                            <option value="Asia/Tehran"
                                                <?php echo e($tz ? ($tz == 'Asia/Tehran' ? 'selected' : '') : ''); ?>>(GMT+03:30)Tehran</option>
                                            <option value="Asia/Muscat"
                                                <?php echo e($tz ? ($tz == 'Asia/Muscat' ? 'selected' : '') : ''); ?>>(GMT+04:00)Abu Dhabi,Muscat</option>
                                            <option value="Asia/Baku"
                                                <?php echo e($tz ? ($tz == 'Asia/Baku' ? 'selected' : '') : ''); ?>>(GMT+04:00)Baku</option>
                                            <option value="Asia/Yerevan"
                                                <?php echo e($tz ? ($tz == 'Asia/Yerevan' ? 'selected' : '') : ''); ?>>
                                                (GMT+04:00) Yerevan</option>
                                            <option value="Asia/Kabul"
                                                <?php echo e($tz ? ($tz == 'Asia/Kabul' ? 'selected' : '') : ''); ?>>(GMT+04:30)Kabul</option>
                                            ...
                                            <option value="Asia/Almaty"
                                                <?php echo e($tz ? ($tz == 'Asia/Almaty' ? 'selected' : '') : ''); ?>>(GMT+06:00)Almaty, Novosibirsk</option>
                                            <option value="Asia/Dhaka"
                                                <?php echo e($tz ? ($tz == 'Asia/Dhaka' ? 'selected' : '') : ''); ?>>(GMT+06:00)Astana, Dhaka</option>
                                            ...
                                            <option value="Asia/Taipei"
                                                <?php echo e($tz ? ($tz == 'Asia/Taipei' ? 'selected' : '') : ''); ?>>(GMT+08:00)Taipei</option>
                                            <option value="Asia/Tokyo"
                                                <?php echo e($tz ? ($tz == 'Asia/Tokyo' ? 'selected' : '') : ''); ?>>(GMT+09:00)Osaka, Sapporo, Tokyo</option>
                                            <option value="Asia/Seoul"
                                                <?php echo e($tz ? ($tz == 'Asia/Seoul' ? 'selected' : '') : ''); ?>>(GMT+09:00)Seoul</option>
                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        <select id="time_format" name="time_format" class="form-control">
                                            <option value="12" <?php echo e($tf == '12' ? 'selected' : ''); ?>>
                                                <?php echo e(translate('messages.12_hour')); ?> </option>
                                            <option value="24" <?php echo e($tf == '24' ? 'selected' : ''); ?>>
                                                <?php echo e(translate('messages.24_hour')); ?> </option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-md-4 col-xl-3">
                                    ...
                                    <div class="form-group mb-0">
                                        <label class="form-label"
                                            for="currency"><?php echo e(translate('Currency Symbol')); ?></label>
                                        <select id="change_currency" name="currency" class="form-control js-select2-custom">
                                            <?php $__currentLoopData = \App\Models\Currency::orderBy('currency_code')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $currency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><option value="<?php echo e($currency['currency_code']); ?>"
                                ...
                                <div class="col-sm-6 col-md-4 col-xl-3">
                                    ...
                                    <div class="form-group mb-0">
                                        <label class="form-label text-capitalize"
                                            for="currency_symbol_position"><?php echo e(translate('Currency Position')); ?>

                                        </label>
                                        <div class="resturant-type-group border">
                                            <label class="form-check form--check mr-2 mr-md-4">
                                                <input class="form-check-input" type="radio" value="left" name="currency_symbol_position" <?php echo e($currency_symbol_position ? ($currency_symbol_position->value == 'left' ? 'checked' : '') : ''); ?>>
                                                <span class="form-check-label">
                                                    ($) <?php echo e(translate('Left')); ?>

                                                </span>
                                            </label>
                                            <label class="form-check form--check mr-2 mr-md-4">
                                                <input class="form-check-input" type="radio" value="right" name="currency_symbol_position" <?php echo e($currency_symbol_position ? ($currency_symbol_position->value == 'right' ? 'checked' : '') : ''); ?>>
                                                <span class="form-check-label">
                                                    <?php echo e(translate('Right')); ?> ($)
                                                </span>
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-6 col-md-4 col-xl-3">
                                    ...
                                    <div class="form-group mb-0">
                                        <label class="form-label text-capitalize"
                                            for="digit_after_decimal_point"><?php echo e(translate('messages.Digit after decimal point')); ?>

                                            <span class="form-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo e(translate('how_many_fractional_digit_to_show_after_decimal_value')); ?>">
                                        ...
                                        <input type="number" name="digit_after_decimal_point" class="form-control"
                                            id="digit_after_decimal_point" placeholder="<?php echo e(translate('messages.ex_:_2')); ?>"
                                ...
                                <div class="col-md-4 col-xl-5">
                                    ...
                                    <div class="form-group mb-0">
                                        <label class="form-label"
                                            for="footer_text"><?php echo e(translate('Copyright Text')); ?>

                                            <span class="form-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo e(translate('messages.make_visitors_aware_of_your_business‘s_rights_&_legal_information.')); ?>">
                                                <img src="<?php echo e(asset('public/assets/admin/img/info-circle.svg')); ?>" alt="">
                                            </span>
                                        </label>
                                        <textarea type="text" id="footer_text" name="footer_text" class="form-control h--45"
                                            placeholder="<?php echo e(translate('messages.Ex_:_Copyright_Text')); ?>" required><?php echo e($footer_text->value ?? ''); ?></textarea>
                                    </div>
                                </div>
                                <div class="col-md-4 col-xl-4">
                                    ...
                                    <div class="form-group mb-0">
                                        <label class="form-label"
                                            for="cookies_text"><?php echo e(translate('Cookies Text')); ?>
                                        ...
                                        <textarea type="text"  id="cookies_text" name="cookies_text" class="form-control h--45"
                                            placeholder="<?php echo e(translate('messages.Ex_:_Cookies_Text')); ?>" required><?php echo e($cookies_text->value ?? ''); ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-12">
                    <h4 class="card-title mb-3 d-flex align-items-center"> <span class="card-header-icon mr-2"><i
                        ...
                        <span><?php echo e(translate('messages.Business_Rules_setup')); ?> </span></h4>
                    <div class="card">
                        <div class="card-body">
                            <div class="row g-3 align-items-end">
                                <div class="col-sm-6 col-lg-4">
                                    ...
                                    <div class="form-group mb-0">
                                        <label class="form-label text-capitalize"
                                            ...
                                            <?php echo e(translate('messages.Default_Commission_Rate_On_Order')); ?> (%)
                                            <span class="form-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo e(translate('messages.Set_up_‘Default_Commission_Rate’_on_every_Order._Admin_can_also_set_store-wise_different_commission_rates_from_respective_store_settings.')); ?>">
                                                <img src="<?php echo e(asset('public/assets/admin/img/info-circle.svg')); ?>" alt="">
                                            </span>
                                        </label>
                                        <input type="number" name="admin_commission" class="form-control"
                                            id="admin_commission" placeholder="<?php echo e(translate('messages.Ex:_10')); ?>"
                                ...
                                <div class="col-sm-6 col-lg-4">
                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        <?php echo e(translate('messages.Commission_Rate_On_Delivery_Charge')); ?> (%)
                                            <span class="form-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo e(translate('messages.Set_a_default_‘Commission_Rate’_for_freelance_deliverymen_(under_admin)_on_every_deliveryman. ')); ?>">
                                                <img src="<?php echo e(asset('public/assets/admin/img/info-circle.svg')); ?>" alt="">
                                            </span>
                                        </label>
                                            <input type="number" name="admin_comission_in_delivery_charge" class="form-control" id="admin_comission_in_delivery_charge"  placeholder="<?php echo e(translate('messages.Ex:_10')); ?>"
                                        ...
                                        <label
                                            ...
                                            <span class="pr-1 d-flex align-items-center switch--label">
                                                ...
                                                <span class="form-label-secondary text-danger d-flex"
                                                    ...
                                                    data-original-title="<?php echo e(translate('messages.If_this_feature_is_active,_customers_can_filter_food_according_to_their_preference_from_the_Customer_App_or_Website.')); ?>"><img
                                                        src="<?php echo e(asset('/public/assets/admin/img/info-circle.svg')); ?>"
                                            ...
                                            <input type="checkbox"
                                                   data-id="vnv1"
                                                   data-type="toggle"
                                                   data-image-on="<?php echo e(asset('/public/assets/admin/img/modal/veg-on.png')); ?>"
                                                   data-image-off="<?php echo e(asset('/public/assets/admin/img/modal/veg-off.png')); ?>"
                                ...
                                <div class="col-sm-6 col-lg-4">
                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        <span class="form-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo e(translate('For_Firebase,_a_single_real-time_notification_will_be_sent_upon_order_placement,_with_no_repetition._For_the_Manual_option,_notifications_will_appear_at_10-second_intervals_until_the_order_is_viewed.')); ?>" >
                                            <img src="<?php echo e(asset('public/assets/admin/img/info-circle.svg')); ?>" alt="">
                                        </span>
                                        </span>
                                        </label>
                                    ...
                                    <div class="form-group mb-0">
                                        <label
                                            ...
                                            <input type="checkbox"
                                                   ...
                                                   data-type="toggle"
                                                   data-image-on="<?php echo e(asset('/public/assets/admin/img/modal/dm-tips-on.png')); ?>"
                                                   data-image-off="<?php echo e(asset('/public/assets/admin/img/modal/dm-tips-off.png')); ?>"
                                    ...
                                    <div class="form-group mb-0">
                                        <label
                                            ...
                                            <span class="pr-1 d-flex align-items-center switch--label">
                                                ...
                                                <span class="form-label-secondary text-danger d-flex"
                                                    data-toggle="tooltip" data-placement="right"
                                                    data-original-title="<?php echo e(translate('messages.If_you_enable_this_option,_in_all_phone_no_field_will_show_a_country_picker_list.')); ?>"><img
                                                        src="<?php echo e(asset('/public/assets/admin/img/info-circle.svg')); ?>"
                                                        alt="<?php echo e(translate('messages.customer_varification_toggle')); ?>">
                                                </span>
                                            </span>
                                            ...
                                            value="1"
                                                ...
                                                <?php echo e($country_picker_status == 1 ? 'checked' : ''); ?>>
                                            <span class="toggle-switch-label text">
                                                <span class="toggle-switch-indicator"></span>
                                            </span>
                                        </label>
                                ...
                                <div class="card-body">
                                    <div class="row g-3 align-items-end">
                                        <div class="col-sm-6 col-lg-6">
                                            ...
                                            <div class="form-group mb-0">
                                                <label class="input-label text-capitalize d-flex alig-items-center add_text_mute <?php echo e($admin_free_delivery_status?->value ? '' : 'text-muted'); ?> "><span
                                                ...
                                                <div class="resturant-type-group border bg-white">
                                                    <label class="form-check form--check">
                                                        <input class="form-check-input radio-trigger" type="radio"   <?php echo e($admin_free_delivery_status?->value ? '' : 'disabled'); ?>  value="free_delivery_to_all_store" name="admin_free_delivery_option" <?php echo e($admin_free_delivery_option?->value == 'free_delivery_to_all_store' ? 'checked' : ''); ?>>
                                                        <span class="form-check-label">
                                                    ...
                                                    <label class="form-check form--check">
                                                        <input class="form-check-input radio-trigger  <?php echo e($admin_free_delivery_option?->value == null ? 'radio-disable-bg' : ''); ?>"   type="radio" <?php echo e($admin_free_delivery_status?->value ? '' : 'disabled'); ?>  value="free_delivery_by_order_amount" name="admin_free_delivery_option" <?php echo e($admin_free_delivery_option?->value == 'free_delivery_by_order_amount' || $admin_free_delivery_option?->value == null ? 'checked' : ''); ?>>
                                                        <span class="form-check-label">
                                        ...
                                        <div id="show_free_delivery_over" class="col-sm-6 col-lg-6 <?php echo e($admin_free_delivery_option?->value == 'free_delivery_by_order_amount' ||  $admin_free_delivery_option?->value  == null ? '' : 'd-none'); ?>">
                                            <div class="form-group mb-0">
                                                <label class="form-label d-flex justify-content-between text-capitalize mb-1 add_text_mute <?php echo e($admin_free_delivery_status?->value ? '' : 'text-muted'); ?> "
                                                    for="">
                                                ...
                                                <input type="number"  name="free_delivery_over" class="form-control"
                                                    ...
                                                    min="0" step=".01"
                                                    <?php echo e($admin_free_delivery_option?->value == 'free_delivery_by_order_amount' ? 'required' : 'readonly'); ?>


                                                    >
                                            </div>
                                        </div>
                                        <div id="show_text_for_all_store_free_delivery" class="col-sm-6 col-lg-6 <?php echo e($admin_free_delivery_option?->value == 'free_delivery_to_all_store'  ? '' : ' d-none'); ?>">
                                            <div class="alert fs-13 alert-primary-light text-dark mb-0  mt-md-0 add_text_mute text-muted" role="alert">
                                                ...
                                                <?php echo e(translate('Free delivery is active for all stores. Cost bearer for the free delivery is')); ?> <strong><?php echo e(translate('Admin')); ?></strong>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="__bg-F8F9FC-card p-0 mt-4">
                                <div class="border-bottom p-3">
                                    <h4 class="card-title m-0 text--title"><?php echo e(translate('Additional Charge')); ?></h4>
                                </div>
                                <div class="card-body">
                                    <div class="row g-3 align-items-end">
                                        <div class="col-sm-6 col-lg-4">
                                            ...
                                            <div class="form-group mb-0">
                                                <label
                                                    ...
                                                    <span class="pr-1 d-flex align-items-center switch--label">
                                                        <span class="line--limit-1">
                                                            <?php echo e(translate('messages.additional_charge')); ?>
                                                    ...
                                                    <input type="checkbox"
                                                        ...
                                                        data-image-on="<?php echo e(asset('/public/assets/admin/img/modal/dm-tips-on.png')); ?>"
                                                        data-image-off="<?php echo e(asset('/public/assets/admin/img/modal/dm-tips-off.png')); ?>"
                                                        data-title-on="<strong><?php echo e(translate('messages.Want_to_enable_additional_charge?')); ?></strong>"
                                                        data-title-off="<strong><?php echo e(translate('messages.Want_to_disable_additional_charge?')); ?></strong>"
                                                        data-text-on="<p><?php echo e(translate('messages.If_you_enable_this,_additional_charge_will_be_added_with_order_amount,_it_will_be_added_in_admin_wallet')); ?></p>"
                                                        data-text-off="<p><?php echo e(translate('messages.If_you_disable_this,_additional_charge_will_not_be_added_with_order_amount.')); ?></p>"
                                                        class="status toggle-switch-input dynamic-checkbox-toggle"
                                                        value="1"
                                        ...
                                        <div class="col-sm-6 col-lg-4">
                                            ...
                                            <div class="form-group mb-0">
                                                ...
                                                <input type="text" name="additional_charge_name" class="form-control"
                                                    ...
                                                    value="<?php echo e($additional_charge_name ? $additional_charge_name->value : ''); ?>" <?php echo e(isset($additional_charge_status) ? '' : 'readonly'); ?> required>
                                            </div>
                                        </div>
                                        <div class="col-sm-6 col-lg-4">
                                            ...
                                            <div class="form-group mb-0">
                                                ...
                                                <input type="number" name="additional_charge" class="form-control"
                                                    ...
                                                    min="0" step=".01" <?php echo e(isset($additional_charge_status) ? '' : 'readonly'); ?>>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="__bg-F8F9FC-card p-0 mt-4">
                                <div class="border-bottom p-3">
                                    <h4 class="card-title m-0 text--title"><?php echo e(translate('Payment')); ?></h4>
                                </div>
                                <div class="card-body">
                                    <div class="row g-3 align-items-end">
                                        <div class="col-sm-6 col-lg-4">
                                            ...
                                            <div class="form-group mb-0">
                                                <label
                                                    ...
                                                    <input type="checkbox"
                                                        ...
                                                        data-title-on="<?php echo e(translate('messages.Want_to_enable')); ?> <strong><?php echo e(translate('messages.partial_payment_?')); ?></strong>"
                                                        data-title-off="<?php echo e(translate('messages.Want_to_disable')); ?> <strong><?php echo e(translate('messages.partial_payment_?')); ?></strong>"
                                                        data-text-on="<p><?php echo e(translate('messages.If_you_enable_this,_customers_can_choose_partial_payment_during_checkout.')); ?></p>"
                                                        data-text-off="<p><?php echo e(translate('messages.If_you_disable_this,_the_partial_payment_feature_will_be_hidden.')); ?></p>"
                                                        class="status toggle-switch-input dynamic-checkbox-toggle"
                                                        value="1"
                            ...
                            <div class="__bg-F8F9FC-card p-0 mt-4">
                                <div class="border-bottom p-3">
                                    <h4 class="card-title m-0 text--title"><?php echo e(translate('Business_Plan')); ?></h4>
                                </div>
                                <div class="card-body">
                                    <div class="row g-3 align-items-end">
                                        <div class="col-sm-6 col-lg-4">
                                            ...
                                            <div class="form-group mb-0">
                                                <label
                                                    ...
                                                    <span class="pr-1 d-flex align-items-center switch--label">
                                                        ...
                                                        <span class="form-label-secondary text-danger d-flex"
                                                            data-toggle="tooltip" data-placement="right"
                                                            data-original-title="<?php echo e(translate('If_enabled,_the_package_based_subscription_business_model_option_will_be_available_for_stores')); ?>"><img
                                                                src="<?php echo e(asset('/public/assets/admin/img/info-circle.svg')); ?>"
                                                                alt="<?php echo e(translate('messages.customer_varification_toggle')); ?>"> *
                                                        </span>
                                                    </span>
                                                    ...
                                                    data-image-on="<?php echo e(asset('/public/assets/admin/img/modal/mail-success.png')); ?>"
                                                    data-image-off="<?php echo e(asset('/public/assets/admin/img/modal/mail-warning.png')); ?>"
                                                    data-title-on="<?php echo e(translate('Want_to_enable_the')); ?> <strong><?php echo e(translate('Subscription_Base')); ?></strong> <?php echo e(translate('Business_Model')); ?> ?"
                                                    data-title-off="<?php echo e(translate('Want_to_disable_the')); ?> <strong><?php echo e(translate('Subscription_Base')); ?> <?php echo e(translate('Business_Model')); ?></strong> ?"
                                                    data-text-on="<p><?php echo e(translate('If_enabled,_the_subscription_based_store_business_model_option_will_be_available_in_this_store')); ?></p>"
                                                    data-text-off="<p><?php echo e(translate('If_disabled,_the_subscription_based_store_business_model_option_will_be_hidden_from_this_store_panel._The_existing_subscribed_stores’_subscriptions_will_be_valid_till_the_packages_expire')); ?></p>"
                                                    class="status toggle-switch-input dynamic-checkbox-toggle"
                                                        value="1"
                                                        name="subscription_business_model" id="subscription_business_model"
                                                        <?php echo e($subscription_business_model == 1 ? 'checked' : ''); ?>>
                                                    <span class="toggle-switch-label text">
                                                        <span class="toggle-switch-indicator"></span>
                                                    </span>
                                                </label>
                                        ...
                                        <div class="col-sm-6 col-lg-4">
                                            ...
                                            <div class="form-group mb-0">
                                                <label
                                                    ...
                                                    <span class="pr-1 d-flex align-items-center switch--label">
                                                        <span class="line--limit-1">
                                                            <?php echo e(translate('Commission')); ?>

                                                        </span>
                                                        <span class="form-label-secondary text-danger d-flex"
                                                            data-toggle="tooltip" data-placement="right"
                                                            data-original-title="<?php echo e(translate('If_enabled,_the_commission_based_business_model_option_will_be_available_for_stores.')); ?>"><img
                                                                src="<?php echo e(asset('/public/assets/admin/img/info-circle.svg')); ?>"
                                                                alt="<?php echo e(translate('messages.customer_varification_toggle')); ?>"> *
                                                        </span>
                                                    </span>
                                                    ...
                                                    data-image-on="<?php echo e(asset('/public/assets/admin/img/modal/mail-success.png')); ?>"
                                                    data-image-off="<?php echo e(asset('/public/assets/admin/img/modal/mail-warning.png')); ?>"
                                                    data-title-on="<?php echo e(translate('Want_to_enable_the')); ?> <strong><?php echo e(translate('Commission_Base')); ?></strong> <?php echo e(translate('Business_Model')); ?> ?"
                                                    data-title-off="<?php echo e(translate('Want_to_disable_the')); ?> <strong><?php echo e(translate('Commission_Base')); ?> <?php echo e(translate('Business_Model')); ?></strong> ?"
                                                    data-text-on="<p><?php echo e(translate('If_enabled,_the_commission_based_store_business_model_option_will_be_available_for_this_store')); ?></p>"
                                                    data-text-off="<p><?php echo e(translate('If_disabled,_the_commission_based_store_business_model_option_will_be_hidden_from_this_store_panel._And_it_can_only_use_the_subscription_based_business_model')); ?></p>"
                                                    class="status toggle-switch-input dynamic-checkbox-toggle"
                                                        value="1"
                                                        name="commission_business_model" id="commission_business_model"
                                                        <?php echo e($commission_business_model == 1 ? 'checked' : ''); ?>>
                                                    <span class="toggle-switch-label text">
                                                        <span class="toggle-switch-indicator"></span>
                                                    </span>
                                                </label>
                    ...
                    <div class="max-349 mx-auto mb-20">
                        <div>
                            <div class="text-center">
                                <img width="80" src="<?php echo e(asset('public/assets/admin/img/modal/currency.png')); ?>" class="mb-20">
                                <h5 class="modal-title"></h5>
                            </div>
                            <div class="text-center" >
                                <h3 > <?php echo e(translate('Are_you_sure_to_change_the_currency_?')); ?></h3>
                                <div > <p><?php echo e(translate('If_you_enable_this_currency,_you_must_active_at_least_one_digital_payment_method_that_supports_this_currency._Otherwise_customers_cannot_pay_via_digital_payments_from_the_app_and_websites._And_Also_restaurants_cannot_pay_you_digitally')); ?></h3></p></div>
                            </div>

                            <div class="text-center mb-4" >
                                <a class="text--underline" href="<?php echo e(route('admin.business-settings.third-party.payment-method')); ?>"> <?php echo e(translate('Go_to_payment_method_settings.')); ?></a>
                            </div>
                            </div>

                        <div class="btn--container justify-content-center">
                            <button data-dismiss="modal" id="confirm-currency-change" class="btn btn--cancel min-w-120" ><?php echo e(translate("Cancel")); ?></button>
                            <button data-dismiss="modal"   type="button"  class="btn btn--primary min-w-120"><?php echo e(translate('OK')); ?></button>
                    ...
                    <div class="max-349 mx-auto mb-20">
                        <div>
                            ...
                            <div class="text-center" >
                                ...
                                <div > <p><?php echo e(translate('Are you sure to active “Set Specific Criteria”? If you active this delivery charge will not added to order when customer order more then your “Free Delivery Over” amount.')); ?></h3></p></div>
                            </div>



                            <div class="btn--container justify-content-center">
                                <button data-dismiss="modal"  class="btn btn-soft-secondary min-w-120" ><?php echo e(translate("Cancel")); ?></button>
                                <button data-dismiss="modal"   type="button"  id="confirmBtn_free_delivery_by_order_amount" class="btn btn--primary min-w-120"><?php echo e(translate('Yes')); ?></button>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="max-349 mx-auto mb-20">
                        <div>
                            ...
                            <div class="text-center" >
                                ...
                                <div > <p><?php echo e(translate('Are you sure to active “Free delivery order for all Stores”? If you active this no delivery charge will added to order and the cost will be added to you.')); ?></h3></p></div>
                            </div>
                            <div class="btn--container justify-content-center">
                                <button data-dismiss="modal"  class="btn btn-soft-secondary min-w-120" ><?php echo e(translate("Cancel")); ?></button>
                                <button data-dismiss="modal"   type="button"  id="confirmBtn_free_delivery_to_all_store" class="btn btn--primary min-w-120"><?php echo e(translate('Yes')); ?></button>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    $("#confirmBtn_free_delivery_by_order_amount").on("click", function () {
      ...
      $(document).ready(function() {
    let selectedCurrency = "<?php echo e($currency_code ? $currency_code->value : 'USD'); ?>";
    ...
    function check_currency(currency) {
        $.ajax({
            ...
            url: "<?php echo e(route('admin.system_currency')); ?>",
            method: 'GET',
    ...
    <script>
        ...
        $(document).on('click', '.maintenance-mode', function () {
            ...
            Swal.fire({
                ...
                text: '<?php echo e(translate('messages.all_your_apps_and_customer_website_will_be_disabled_until_you_‘Turn_Off’ _maintenance_mode.')); ?>',
                type: 'warning',
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Admin\resources\views/admin-views/business-settings/business-index.blade.php ENDPATH**/ ?>