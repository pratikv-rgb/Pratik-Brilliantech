<?php $__env->startSection('title',translate('messages.new_joining_requests')); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <h1 class="page-header-title"><i class="tio-filter-list"></i> <?php echo e(translate('messages.new_joining_requests')); ?></h1>
                ...
                <div class="col-md-12">
                    <div class="js-nav-scroller hs-nav-scroller-horizontal mt-2">
                        ...
                        <ul class="nav nav-tabs mb-3 border-0 nav--tabs">
                            <li class="nav-item">
                                <a class="nav-link active" href="<?php echo e(route('admin.store.pending-requests')); ?>"   aria-disabled="true"><?php echo e(translate('messages.pending_stores')); ?></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(route('admin.store.deny-requests')); ?>"  aria-disabled="true"><?php echo e(translate('messages.denied_stores')); ?></a>
                            </li>
                        </ul>
                        <!-- End Nav -->
                    </div>
                    ...
                    <!-- Search -->
                        ...
                        <div class="input-group input--group">
                            <input id="datatableSearch_" type="search" name="search" class="form-control"
                                    placeholder="<?php echo e(translate('ex_:_Search_Store_Name')); ?>" value="<?php echo e(isset($search_by) ? $search_by : ''); ?>" aria-label="<?php echo e(translate('messages.search')); ?>" required>
                            ...
                            <td>
                                <div class="btn--container">
                                    ...
                                    <?php if(!isset($store->vendor->status)): ?>
                                        ...
                                        data-url="<?php echo e(route('admin.store.application',[$store['id'],0])); ?>" data-message="<?php echo e(translate('messages.you_want_to_deny_this_application')); ?>"
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Admin\resources\views/admin-views/vendor/pending_requests.blade.php ENDPATH**/ ?>