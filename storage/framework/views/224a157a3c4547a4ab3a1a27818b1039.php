                    ...
                    <li class="nav-item max-sm-m-0 w-xxl-200px ml-auto mr-2 flex-grow-0">
                        <button type="button" id="modalOpener" class="title-color bg--secondary border-0 rounded justify-content-between w-100 align-items-center py-2 px-2 px-md-3 d-flex gap-1" data-toggle="modal" data-target="#staticBackdrop">
                            <div class="align-items-center d-flex flex-grow-1 gap-1 justify-content-between">
                                <span class="align-items-center d-none d-xxl-flex gap-2 text-muted"><?php echo e(translate('Search_or')); ?>
                                ...
                                <img width="14" src="<?php echo e(asset('/assets/admin/img/new-img/search.svg')); ?>" class="svg" alt="">
                            </div>
                        </button>
                    </li>
                        ...
                        <div class="hs-unfold">
                                ...
                                <div class="cmn--media right-dropdown-icon d-flex align-items-center">
                                    <div class="media-body pl-0 pr-2">
                                        <span class="card-title h5 text-right">
                                            ...
                                            <?php echo e(\App\CentralLogics\Helpers::get_loggedin_user()->l_name); ?>

                                        </span>
                                        <span class="card-text"><?php echo e(\App\CentralLogics\Helpers::get_loggedin_user()->email); ?></span>
                                    </div>
                                    <div class="avatar avatar-sm avatar-circle">
                                        <img class="avatar-img  onerror-image aspect-1-1"  data-onerror-image="<?php echo e(asset('/assets/admin/img/160x160/img1.jpg')); ?>"
                                        src="<?php echo e(\App\CentralLogics\Helpers::get_loggedin_user()->toArray()['image_full_url']); ?>"
                            ...
                            <div id="accountNavbarDropdown"
                                ...
                                <a class="dropdown-item log-out" >
                                    <span class="text-truncate pr-2 log-out" title="Sign out"><?php echo e(translate('messages.sign_out')); ?></span>
                                </a>
                            </div>
                        </div>
                        <!-- End Account -->
        ...
        <div class="modal-content modal-content__search border-0">
            <div class="d-flex flex-column gap-3 rounded-20 bg-card py-2 px-3">
                <div class="d-flex gap-2 align-items-center position-relative">
                    <form class="flex-grow-1" id="searchForm" action="<?php echo e(route('vendor.search.routing')); ?>">
                        <?php echo csrf_field(); ?>
...
<?php if($Payable_Balance == 1 &&  $cash_in_hand_overflow &&  $wallet?->balance < 0 &&  $val <=  abs($wallet?->collected_cash)  ): ?>
    <div class="alert __alert-2 alert-warning m-0 py-1 px-2" role="alert">
        <img class="rounded mr-1"  width="25" src="<?php echo e(asset('/assets/admin/img/header_warning.png')); ?>" alt="">
        <div class="cont">
...
<?php if($Payable_Balance == 1 &&  $cash_in_hand_overflow &&  $wallet?->balance < 0 &&  $cash_in_hand_overflow_store_amount < $wallet?->collected_cash): ?>
    <div class="alert __alert-2 alert-warning m-0 py-1 px-2" role="alert">
        <img class="mr-1"  width="25" src="<?php echo e(asset('/assets/admin/img/header_warning.png')); ?>" alt="">
        <div class="cont">
            <h4 class="m-0"><?php echo e(translate('Attention_Please')); ?> </h4><?php echo e(translate('The_Cash_in_Hand_amount_limit_is_exceeded._Your_account_is_now_suspended._Please_pay_the_due_amount_to_receive_new_order_requests_again.')); ?><a href="<?php echo e(route('vendor.wallet.index')); ?>" class="alert-link"> &nbsp; <?php echo e(translate('Pay_the_due')); ?></a>
        </div>
    </div>
<?php endif; ?>
...
<?php if( !in_array($store_data->store_business_model, ['none','commission']) && !Request::is('vendor-panel/subscription/*') ): ?>
        ...
        ?>
        <?php if($store_data?->store_sub?->is_trial == 0 && $store_data?->store_sub?->expiry_date_parsed && $store_data?->store_sub->expiry_date_parsed->subDays($subscription_deadline_warning_days)->isBefore(now()) && Request::is('vendor-panel')): ?>

                <!--Always in header Renew -->
                <div class="renew-badge mb-20" id="renew-badge">
                    <div class="renew-content d-flex align-items-center">

                        <img src="<?php echo e(asset('/assets/admin/img/timer.svg')); ?>" alt="">
                        <div class="txt">
                    ...
                    <div>
                        <a href="<?php echo e(route('vendor.subscriptionackage.subscriberDetail',['renew_now' => true])); ?>" class="btn btn--danger"><?php echo e(translate('Renew')); ?></a>
                    </div>
                </div>



        <?php elseif( Session::get('subscription_renew_close_btn') !== true && $store_data?->store_sub?->is_trial == 0  && $store_data?->store_sub?->expiry_date_parsed && $store_data?->store_sub->expiry_date_parsed->subDays($subscription_deadline_warning_days)->isBefore(now()) && !Request::is('vendor-panel')): ?>
                ...
                <div class="renew-badge mb-20 hide-warning" id="renew-badge">
                    ...
                    <div>
                        <?php if($store_data?->store_sub?->is_canceled == 1): ?>
                        <a href="<?php echo e(route('vendor.subscriptionackage.subscriberDetail',['open_plans' => true])); ?>" class="btn btn--danger"><?php echo e(translate('Change_Subscription')); ?></a>
                        <?php else: ?>

                        <a href="<?php echo e(route('vendor.subscriptionackage.subscriberDetail',['renew_now' => true])); ?>" class="btn btn--danger"><?php echo e(translate('Renew')); ?></a>

                        <?php endif; ?>
                        <button  data-id="subscription_renew_close_btn" id="hide-warning"  class="btn btn-sm btn-primary add-to-session" ><?php echo e(translate('remind_me_later')); ?></button>
                    </div>
                </div>
                <!-- Renew -->
        ...
        <?php endif; ?>
        <?php if( Session::get('subscription_free_trial_close_btn') !== true && $store_data?->store_sub?->status == 1 && $store_data?->store_sub?->is_trial == 1 && $store_data?->store_sub?->is_canceled == 0): ?>

        <div class="free-trial trial success-bg">
            <div class="inner-div">
                <div class="left">
                    <img src="<?php echo e(asset('/assets/admin/img/icon-puck.svg')); ?>" alt="">
                    <div class="left-content">
                        <h6><?php echo e(translate('Get the best experience of on demand service business')); ?></h6>
                        <div><?php echo e(translate('Run your on demand business with the most popular platform')); ?></div>
                    </div>
                </div>
                <div class="right">
                    <a href="#" class="btn btn-2">
                        <span class="circle-progress-container">
                            <svg width="40" viewBox="0 0 160 160">
                                ...
                                <circle r="70" cx="80" cy="80" fill="transparent" stroke="#ffffff" stroke-width="12px" stroke-dasharray="439.6px" stroke-dashoffset="<?php echo e($pers); ?>px"></circle>
                            </svg>
                            <?php echo e(Carbon\Carbon::now()->diffInDays($store_data?->store_sub?->expiry_date_parsed->format('Y-m-d'), false)); ?>

                        </span>
                        <?php echo e(translate('Days_left_in_free_trial')); ?>

                    </a>
                    <a href="<?php echo e(route('vendor.subscriptionackage.subscriberDetail' ,['open_plans' => true])); ?>" class="btn btn-light"><?php echo e(translate('Choose_Subscription_Plan')); ?> <i class="tio-arrow-forward"></i></a>
                </div>
        ...
        <?php elseif($store_data?->store_sub == null && $store_data?->store_sub_update_application?->is_trial == 1): ?>
                    ...
                    <div class="modal-body p-0">
                        <div class="trial-ended-modal-wrapper">
                            <div class="trial-ended-modal-content align-self-center">
                                ...
                                <a href="<?php echo e(route('vendor.subscriptionackage.subscriberDetail' ,['open_plans' => true])); ?>" class="btn btn--primary"><?php echo e(translate('Choose Subscription Plan')); ?> <i class="tio-arrow-forward"></i></a>
                                <div class="blocked-subscription mt-5">
                                    <img src="<?php echo e(asset('/assets/admin/img/WarningOctagon.svg')); ?>" alt="">
                            ...
                            <div class="trial-ended-modal-img d-none d-md-block">
                                <img src="<?php echo e(asset('/assets/admin/img/trial-ended-bg.png')); ?>" alt="">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="free-trial trial danger-bg">
            <div class="inner-div">
                <div class="left">
                    <img src="<?php echo e(asset('/assets/admin/img/timer-2.svg')); ?>" alt="">
                    <div class="left-content">
        ...
        <?php elseif( Session::get('subscription_cancel_close_btn') !== true &&  $store_data?->store_sub  && $store_data?->store_sub?->is_canceled == 1): ?>
        <div class="free-trial trial danger-bg">
            <div class="inner-div">
                <div class="left">
                    <img src="<?php echo e(asset('/assets/admin/img/timer-2.svg')); ?>" alt="">
                    <div class="left-content">
                        <h6><?php echo e(translate('Your_Subscription_Has_Been_Cnaceled_by')); ?> <?php echo e($store_data?->store_sub?->canceled_by == 'admin' ? translate($store_data?->store_sub?->canceled_by) : translate('Yourself')); ?></h6>
                        <div><?php echo e(translate('You_can_not_consume_your_subscription_after')); ?> <?php echo e(\App\CentralLogics\Helpers::date_format($store_data?->store_sub?->expiry_date_parsed)); ?></div>
                    </div>
                </div>
                <div class="right">
                    <a href="" class="btn btn-2">
                    ...
                    <a href="<?php echo e(route('vendor.subscriptionackage.subscriberDetail' ,['open_plans' => true])); ?>" class="btn btn-light"><?php echo e(translate('Change_Subscription_Plan')); ?> <i class="tio-arrow-forward"></i></a>
                </div>
        ...
        <?php elseif( Session::get('subscription_plan_update_close_btn') !== true &&  $store_data?->store_sub  && $store_data?->store_sub?->package?->status != 1): ?>
        <div class="free-trial trial danger-bg">
            <div class="inner-div">
                <div class="left">
                    <img src="<?php echo e(asset('/assets/admin/img/timer-2.svg')); ?>" alt="">
                    <div class="left-content">
                        ...
                        <div><?php echo e(translate('You_can_not_renew_this_Package_after')); ?> <?php echo e(\App\CentralLogics\Helpers::date_format($store_data?->store_sub?->expiry_date_parsed)); ?>. <?php echo e(translate('to_continue_your_subscription_please_chose_another_package.')); ?></div>
                    </div>
                </div>
                <div class="right">
                    <a href="" class="btn btn-2">
        ...
        <?php elseif($store_data?->store_sub == null): ?>
        <div class="free-trial trial danger-bg">
            <div class="inner-div">
                <div class="left">
                    <img src="<?php echo e(asset('assets/admin/img/timer-2.svg')); ?>" alt="">
                    <div class="left-content">
                        <h6><?php echo e(translate('Your_Subscription_Has_Been_Expired_on')); ?> <?php echo e(\App\CentralLogics\Helpers::date_format($store_data?->store_sub_update_application?->expiry_date_parsed)); ?> </h6>
                        <div><?php echo e(translate('Purchase a subscription plan or contact with the admin to settle the payment and unblock the access to service')); ?> </div>
                    </div>
                </div>
                <div class="right">

                    <a href="<?php echo e(route('vendor.subscriptionackage.subscriberDetail' ,['open_plans' => true])); ?>" class="btn btn-light"><?php echo e(translate('Change/Renew Subscription_Plan')); ?> <i class="tio-arrow-forward"></i></a>
                </div>
            </div>
        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
                ...
                $(document).on('click', '.add-to-session', function () {
                    ...
                    $.ajax({
                        url: '<?php echo e(route('vendor.subscription.addToSession')); ?>',
                        method: 'POST',
                        data: {
                            value: session_data,
...
<?php /**PATH C:\xampp\htdocs\Admin\resources\views/layouts/vendor/partials/_header.blade.php ENDPATH**/ ?>